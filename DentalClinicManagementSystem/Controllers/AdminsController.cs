...
namespace DentalClinicManagementSystem.Controllers
{
    public class AdminsController : Controller
    {
        ...
        [Authorize]
        public ActionResult Create([Bind(Include = "AdminId,AdminFname,AdminLname")] Admin admin)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public ActionResult Edit([Bind(Include = "AdminId,AdminFname,AdminLname")] Admin admin)
        {
            admin.UserId = User.Identity.GetUserId();
